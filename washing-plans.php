                    ...
                    <div class="col-md-4">
                        <div class="price-item">
                            <div class="price-header">
                                <h3>Basic Package</h3>
                                <h2><span>Ksh.</span><strong>10</strong><span>00</span></h2>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="price-item featured-item">
                            <div class="price-header">
                                ...
                                <h2><span>Ksh.</span><strong>20</strong><span>00</span></h2>
                            </div>
                            <div class="price-body">
                                <ul>
                                    <li><i class="far fa-check-circle"></i>Seats Washing</li>
...
<form method="post">   
  <p>
            <select name="packagetype" required class="form-control">
                ...
                <option value="1">BASIC CLEANING (Ksh 1000)</option>
                 <option value="2">PREMIUM CLEANING (Ksh 2000)</option>
                  <option value="3 ">COMPLEX CLEANING(Ksh 3000)</option>
              </select>
